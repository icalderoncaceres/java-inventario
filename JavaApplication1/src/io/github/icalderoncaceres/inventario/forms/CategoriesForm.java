...
public class CategoriesForm extends javax.swing.JFrame {
    ...
    public CategoriesForm() {
        ...
        modelo.addRow(new Object[]{"1","1","Categoria 1","True"});
    }
    ...
    private void initComponents() {
        ...
        btnGoBack.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        btnGoBack.setText("Go back");

        tableCategories.setModel(modelo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
